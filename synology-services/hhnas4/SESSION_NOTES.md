...
- Public URL: `https://gitea.<homelab-domain>`
- SSH Git endpoint: `gitea.<homelab-domain>:2222`
...
- DSM reverse proxy must point `gitea.<homelab-domain>:443` to the correct NAS
...
`synology-services/hhnas4/deploy.sh` now:
